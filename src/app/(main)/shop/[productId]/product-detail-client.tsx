    ...
    <section className="rounded-xl border-[0.5px] border-border bg-card p-4">
      ...
      <div className="mt-4">
        ...
        <div className="mt-1 flex items-center gap-3">
          <button
            type="button"
            className="flex h-10 w-10 items-center justify-center rounded-[10px] border-[0.5px] border-border text-[15px] font-medium"
      ...
      {mode === 'subscription' && canSubscribe ?
        <div className="mt-4">
          ...
          <select
            className="mt-1 flex h-10 w-full rounded-[10px] border-[0.5px] border-border bg-card px-3 text-[13px] text-foreground focus-visible:border-[#4C956C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4C956C]/12"
            value={frequency}
            onChange={(e) =>
