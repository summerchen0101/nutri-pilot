      ...
      <form onSubmit={onFormSubmit} className="space-y-2">
        <div className="flex gap-2">
          <input
            ...
            className={cn(
              "min-h-11 min-w-0 flex-1 rounded-[10px] border-hairline border-border bg-card px-3 py-2 text-[13px] font-normal text-foreground outline-none transition-[border-color,box-shadow] duration-150 ease-in-out placeholder:text-[var(--color-text-tertiary)] disabled:opacity-60",
          ...
          <button
            ...
            className={cn(
              ...
              "bg-primary hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 disabled:opacity-60",
            )}>
            {analyzing ? (
              <>
                <Spinner />
